...
3. 반드시 아래 ①~⑤ 순서대로, 각 항목이 절대 섞이지 않게 작성할 것:
   ...
   ④ 놀이 내용 — 활동명을 단순 나열하지 말고, 그 놀이 안에서 아이가 구체적으로 어떤 행동·상호작용을 했을지 장면을 상상해 생생하게 서술할 것. 예: '프랑스로 여행하는 놀이'라면 "비행기 표를 들고 탑승구에 줄을 서고, 에펠탑을 블록으로 쌓으며 파리 거리를 흉내 냈어요"처럼 구체적인 놀이 장면으로 표현
   ⑤ 마무리 인사
